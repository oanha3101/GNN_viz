  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ── Palette aliases driven by design tokens ──
        // Any existing code using bg-cyan-500, text-purple-300, etc. now
        // automatically picks up the active theme primary (red in light,
        // cyan in dark) so we have a single accent tone per mode.
        cyan: {
          50: 'var(--c-primary-50)',
          ...
          700: 'var(--c-primary-strong)',
          800: 'var(--c-primary-strong)',
          900: 'var(--c-primary-strong)',
        },
        sky: {
          50: 'var(--c-primary-50)',
          100: 'var(--c-primary-100)',
