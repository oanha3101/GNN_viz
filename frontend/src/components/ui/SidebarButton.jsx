    ...
    <div className="tooltip-container relative">
      <button
        ...
        className={`
          ...
          ${active
            ? 'lab-sidebar-active lab-sidebar-active-fg'
      ...
      >
        {active && (
          <motion.div
            ...
            className="lab-sidebar-active-fill absolute inset-0 rounded-xl z-0"
        ...
        <div className="relative z-10 flex items-center gap-3 w-full justify-center lg:justify-start">
          <Icon
            ...
            className={`transition-all ${active ? 'lab-sidebar-active-fg' : 'opacity-80 group-hover:opacity-100'}`}
          />
          {!collapsed && (
            <span className={`text-[11px] font-semibold truncate ${active ? 'lab-sidebar-active-fg' : 'text-starlight/85'}`}>{label}</span>
          )}
        </div>
        {badge !== null && badge > 0 && (
