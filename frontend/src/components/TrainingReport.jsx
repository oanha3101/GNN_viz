import { X, FileText, Network, Globe2, BarChart3, MessageSquare, Lightbulb } from 'lucide-react'
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-950/78 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="w-full max-w-5xl max-h-[88vh] overflow-hidden rounded-[28px] border border-slate-700/40 bg-[#07101f] shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-800/70 px-6 py-5">
          <div>
            <div className="text-[11px] uppercase tracking-[0.28em] text-cyan-300/80 mb-1 flex items-center gap-1.5">
              <FileText size={12} /> Báo cáo huấn luyện
            </div>
        ...
        <div className="max-h-[calc(88vh-96px)] overflow-y-auto px-6 py-5 space-y-4 custom-scrollbar">
          <Section title="1. Mô hình vừa làm gì" icon={Lightbulb}>
          ...
          <Section title="2. Cách đọc từng vùng trên màn hình" icon={Network}>
          ...
          <Section title="3. Cơ chế của model hiện tại" icon={Globe2}>
          ...
          <Section title="4. Vì sao biểu đồ lại đổi trong lúc train" icon={BarChart3}>
          ...
          <Section title="5. Kết luận nhanh" icon={MessageSquare}>
